    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.product.*') || Route::is('admin.active.product') || Route::is('admin.pending.product') || Route::is('admin.product-variant') || Route::is('admin.product.create') || Route::is('admin.product-review.*') || Route::is('admin.product-type-page.*') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                <li class="{{ Route::is('admin.product.create') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.product.create') }}">{{__('admin.Create Product')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.category.*') || Route::is('admin.assign-home-category') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i><span>{{__('admin.Manage Category')}}</span></a>

            <ul class="dropdown-menu">

                <li class="{{ Route::is('admin.category.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.category.index') }}">{{__('admin.Category List')}}</a></li>

                <li class="{{ Route::is('admin.assign-home-category') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.assign-home-category') }}">{{__('admin.Homepage Category')}}</a></li>
          ...
          <li class="nav-item dropdown {{  Route::is('admin.provider') || Route::is('admin.seller-requests') || Route::is('admin.seller-request') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-users"></i><span>{{__('admin.Manage Seller')}}</span></a>
            <ul class="dropdown-menu">

                <li class="{{ Route::is('admin.provider') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.provider') }}">{{__('admin.Seller List')}}</a></li>

                <li class="{{ Route::is('admin.seller-requests') || Route::is('admin.seller-request') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-requests') }}">{{__('admin.Seller Request')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.maintainance-mode') || Route::is('admin.seo-setup') || Route::is('admin.default-avatar') ||  Route::is('admin.testimonial.*') || Route::is('admin.partner.*') || Route::is('admin.counter') || Route::is('admin.ad') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ Route::is('admin.partner.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.partner.index') }}">{{__('admin.Slider')}}</a></li>
                ...
                <li class="{{ Route::is('admin.ad') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.ad') }}">{{__('admin.Ads Banner')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.footer.*') || Route::is('admin.social-link.*') || Route::is('admin.footer-link.*') || Route::is('admin.second-col-footer-link') || Route::is('admin.third-col-footer-link') || Route::is('admin.header-info') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ Route::is('admin.header-info') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.header-info') }}">{{__('admin.Header Info')}}</a></li>
        ...
        <li class="{{ Route::is('admin.payment-addon') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.payment-addon') }}"><i class="fas fa-dollar-sign"></i> <span>{{__('admin.Gateway')}}<span class="badge badge-danger addon_text">{{__('admin.addon')}}</span></span></a></li>
        ...
        @endif
          ...
          <li class="nav-item dropdown {{ Route::is('admin.admin-language') || Route::is('admin.admin-validation-language') || Route::is('admin.website-language') || Route::is('admin.website-validation-language') || Route::is('admin.languages') ? 'active' : '' }}">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i><span>{{__('admin.Manage Language')}}</span></a>
