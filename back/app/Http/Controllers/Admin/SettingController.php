...
class SettingController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.setting',compact('setting','cookieConsent','googleRecaptcha','tawkChat','googleAnalytic','customPaginations','facebookPixel','currencies','selected_theme'));
    }
